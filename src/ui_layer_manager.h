...
void init_active_ui_layers (ActiveUILayers* active_ui_layers,
                            size_t          layer_count);
...
void add_active_ui_layer (Context* c, ActiveUILayers* active_ui_layers,
                          UILayer* ui_layer);
void add_modal (Context* c, ModalID modal_id);
void add_overlay (Context* c, OverlayID overlay_id);
void remove_active_ui_layer (ActiveUILayers* active_ui_layers,
                             UILayer*        ui_layer);
void remove_modal (ModalID modal_id);
void remove_overlay (OverlayID overlay_id);
void update_active_ui_layers (Context* c, ActiveUILayers* active_ui_layers,
                              float dt);
